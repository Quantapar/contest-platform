    ...
    >
      ...
      <div className="space-y-1 border-t border-border pt-4 font-mono text-[10px] uppercase text-muted-foreground">
        ...
        <div className="flex justify-between pt-2 mt-2 border-t border-border/50">
          <span>Organizer</span>
          <span className="text-foreground">{contest.creatorName}</span>
        </div>
      </div>
      ...
      <div className="mt-6">
        ...
        >
          {status === "live" ? "Join" : status === "upcoming" ? "Details" : "Review"}
        </Button>
      </div>
    </div>
  );
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12 border-b border-border pb-6">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tighter uppercase mb-2">Contests</h1>
